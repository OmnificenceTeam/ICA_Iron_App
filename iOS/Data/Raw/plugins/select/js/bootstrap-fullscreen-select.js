    ...
    Mobileselect.prototype = {
        ...
        _appendOptionsList: function () {
            ...
            $.each(this.options, function (i, a) {
                ...
                if (that.title.toLowerCase().indexOf('medicine shape') > -1) {
                    that.$listcontainer.append('<a href="#" class="mobileSelect-control" ' + b + ' data-value="' + a.value + '"><i class="' + a.value + '"></i></a>');
                }
                else if (that.title.toLowerCase().indexOf('medicine color') > -1) {
                    that.$listcontainer.append('<a href="#" class="mobileSelect-control" ' + b + ' data-value="' + a.value + '"><b style="background:' + a.value + '">SA</b>&nbsp;&nbsp;' + a.text + '</a>');
                }
                else {
        ...
        _updateBtnCount: function () {
            ...
            if (this.$triggerElement.is('button') && this.$triggerElement.hasClass('btn-mobileSelect-gen')) {
                ...
                var b = null;
                if (this.title.toLowerCase().indexOf('medicine shape') > -1) {
                    b = '<i class="' + this.$e.val() + '"></i>';
                }
                else {
                    b = this.$triggerElement.next().find('option:selected').text() || this.$e.val();
                }
                
                var c = this.$e.attr('data-btntitle'),
