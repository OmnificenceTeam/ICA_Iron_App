function ReportController($scope) {
    ...
    var date = new Date();
    $scope.curDate =date.getDate() + '/' + (date.getMonth() + 1) + '/' + date.getFullYear();
    ...
    // $scope.yearStatus = g_medicineList.getYearStatus();
    // $scope.weekStatus = null;
    // $scope.monthStatus = null;
    // $scope.yearStatus = null;
