...
IL_001c:
		{
			...
			NullCheck(L_7);
			VirtActionInvoker1< uint8_t >::Invoke(23 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_7, (uint8_t)((int32_t)32));
			goto IL_0066;
		}
...
IL_003f:
		{
			...
			NullCheck(L_16);
			VirtActionInvoker1< uint8_t >::Invoke(23 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_16, L_20);
			goto IL_0066;
		}
...
IL_005b:
		{
			...
			NullCheck(L_21);
			VirtActionInvoker1< uint8_t >::Invoke(23 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_21, L_25);
		}
...
IL_0074:
		{
			...
			NullCheck(L_29);
			ByteU5BU5D_t3397334013* L_30 = VirtFuncInvoker0< ByteU5BU5D_t3397334013* >::Invoke(30 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_29);
			V_2 = L_30;
